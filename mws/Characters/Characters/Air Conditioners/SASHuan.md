...
SASHuan is a [character](Characters.md) as a contestant on the [Megarchive Warehouse Show](Megarchive%20Warehouse%20Show.md).
## Identity

SASHuan is a Mitsubishi Electric floor-standing PSH-6GJHSA [heat pump](../../Species/Air%20Conditioners.md). 

Heiling (partly) from Mother Russia, is he. Also Spanish, because he is also `Juan`. Yes, that's right he is `Juan`. `Juan` is indeed also his name. So, he is Spanish-Russian.

SASHuan/`Juan` is white, but funnily he is still pristine and white, not yellowed unlike the other that are actually **O L D** ([Aufs](Aufs.md)).

Name derived from P**SH**-6GJ**SA**, and also Juan because [Juan](https://knowyourmeme.com/memes/juan-horse-on-balcony) and [Juan](https://knowyourmeme.com/memes/juan), so **SASH** + Juan = SASHuan. Feel free to call him `Sash` if you want to, or `Juan`. Like I said, SAShuan is also `Juan`.
...
## Personality
> TLDR: Slightly anxious and nervous, but very briliant
> TLDR2: That one (organic) chemist who is very smart, but umm terrible at socialization.
> TLDR3: Think of SASHuan as that scientist who was isolated for too long while stoichiometring.
> TLDR4: Juan

SASHuan, you can say, is that one scientist who is anxious and nervous about anything. He never seems to settle down, always on alert and ready for something. Quite jumpy to say. You can also say, that he is the sweat.

He may be terrible at socialization, but he smart. Despite this, he can thrive and survive even with this socialization bottleneck (CeRNY and Flerovy). Idk why, but I think logical minds can work together. Think of SASHuan as that one guy who was isolated for too long.

Juan

## Relations

### [CeRNY](../../Bench/Air%20Conditioners/CeRNY.md) and [Flerovy](Flerovy.md)

These 3 are the perfect partners in science. Very good people grouping here, yeah.
...
A well-oiled trio they are. CeRNY, SASHuan, and Flerovy, are capable of executing some of the greatest chemical feats (they have ever seen). They know how to handle a lot of crazy things, which may or may not be: `nitrating toluene into TNT`, `handling nitroglycerin`, etc... Funny, SASHuan thrives here despite his socialization..

They are great at working together, and they have no qualms of animosity. They hang out with each other, cus they great. Somehow SASHuan can work with them despite his socialization skills being a **NOT**.

### [WELLPan](WELLPan.md) and [ToshyFEN](ToshyFEN/ToshyFEN.md)
...
### [PFSA](PFSA.md), [ASTAC](ASTAC.md), and [CKHSC](CKHSC.md)
